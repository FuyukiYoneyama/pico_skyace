...
- 画面転送上限は約19fps（ゲームタイマー33ms、sysclk 250MHz、LCD 31.25MHz SPI相当。電源再投入時の表示安定性を優先）
...
[`v0.9.14 ビルド記録`](docs/validation/2026-09-12-v0.9.14/BUILD.md)（以前の記録は
...
渡すときは必ず数値を上げること。現在のバージョンは `0.9.14` で、タイトル画面の
