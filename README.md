...
本ファームウェアはLCD転送のためRP2040のシステムクロックを250MHzに設定します。
これはRaspberry Piが公開するRP2040仕様（最大133MHz）を超えるオーバークロックで、
標準PicoCalc個体での動作を確認していますが、RP2040全個体・全電源条件での保証値では
ありません。発熱、電源品質、個体差によって動作余裕が変わる可能性があります。公式仕様は
[RP2040 Tech Specs](https://www.raspberrypi.com/products/rp2040/specifications/)を参照してください。
